...
a.downloadDisabled=!1,a.events.trigger("stopped"),null!=g.getResponseHeader("X-Stats")&&(a.stats=JSON.parse(g.getResponseHeader("X-Stats"))),a.stats&&a.stats.URLLimitReached?a.setMessage("The Sitemap Generator reached the URL limit and the generated sitemap probably isn't complete. You may buy a token for the <a href=\""+b.professionalUrl+"\">Sitemap Generator Pro</a> to crawl up to 50'000 URLs and create a complete sitemap. Additionally to a higher URL limit, the Pro version also adds images and videos to your sitemap.",
